  ...
  const dashboardOptions = [
    {
      ...
      description: 'Your personal wellness overview, analytics, and AI friend',
      icon: User,
      ...
      route: '/employer/personal'
    },
    {
      id: 'organization',
      title: 'Organization Dashboard',
      description: 'Company-wide analytics and employee management',
      icon: Building,
      ...
      <div className="max-w-6xl mx-auto px-2 sm:px-3 md:px-4 lg:px-8 py-6 sm:py-8 lg:py-12">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Choose your dashboard view to access your personal wellness insights or manage your organization's wellness program.
          </p>
        </motion.div>
            ...
            <CardContent className="p-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Get the best of both worlds with separate personal and organizational insights
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                ...
                <div className="flex flex-col items-center space-y-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Monitor organization health</p>
                  </div>
                </div>
