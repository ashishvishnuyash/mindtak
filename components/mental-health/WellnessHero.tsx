        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
                ...
                <CardContent className="p-8">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-gray-700">Instant emotional support</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <CheckCircle className="h-5 w-5 text-green-500" />
                    ...
                    <div className="flex items-center space-x-3">
                      <CheckCircle className="h-5 w-5 text-green-500" />
                      <span className="text-gray-700">Mood tracking & insights</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="grid grid-cols-2 gap-4">
              <motion.div variants={fadeInUp}>
                <Card className="bg-gradient-to-br from-green-50 to-emerald-100 border-0 shadow-lg rounded-xl p-6">
